...
- 上海常住人口中位年龄 42 岁；2025 年美妆品类首店 130+ 家
- 银发（55+）美妆渗透率 35%
...
# 风格
封面 hero：prompt 描述上海外滩天际线画面（东方明珠为主剪影、大太阳盘、黄浦江前景之类，英文），art="shanghai" 做兜底，facts 放 3 个封面大数字（如 42岁 / 130+ / 1:4.7）。
人群章节建议用 hero 图像章节页：prompt 描述梳妆台美妆静物（香水瓶、口红、粉饼镜、睫毛膏之类，英文），art="vanity" 做兜底，facts 放人群数字（如 35% / 42% / +17%）。
目录 items 带 desc 和 pages 芯片；中英双语，英文大写做 mono kicker；数据前置；版式多样、节奏起伏。`,
};
