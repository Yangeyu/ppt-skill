"""怡思丁双抗防晒竞品分析 · morandi look —— 源自完整版报告(2026-07-03)。

数据口径:千瓜 2025.01-10 小红书商业投放;详见报告参考文献。
用法: python demo_isdin_morandi.py [out.pptx] [截图目录]
"""
...
DECK = Deck(
    ...
    theme="morandi",
    slides=[
        # 1 封面 hero —— 防晒主题 t2i(内容 prompt,莫兰迪风格由 look 强制)
        Slide(data=HeroData(
            eyebrow="ISDIN COMPETITIVE · 2026", title="双抗防晒**攻防战**",
            subtitle="怡思丁 × 蜜丝婷 × 安热沙 × 理肤泉 · 小红书五维竞品分析",
            footer="汇报:KIWOO INSIGHT · 2026-07", art="brush",
            prompt="A sunscreen tube lying beside dried flowers and a small "
                   "ceramic vase on linen fabric, soft morning light from a "
                   "window, delicate still life arrangement",
        ...
        Slide(data=TableData(
            ...
            subtitle="小红书商业笔记 · 千瓜 2025.01–10",
        ...
        Slide(data=IconGridData(
            ...
            subtitle="四条需求线 × 两个效率杠杆 · 小红书 2025",
            cards=[
        ...
        Slide(data=TimelineData(
            eyebrow="RHYTHM", title="全年**声量节奏**", subtitle="双峰节奏 + 暑期高原",
            milestones=[
        ...
        Slide(data=HeroData(
            ...
            footer="抗光老 × 抗热老", art="brush",
            prompt="A sunscreen bottle beside a vintage glass thermometer on "
                   "warm linen, dried orange slices and a sprig of eucalyptus, "
                   "soft diffused window light, quiet still life",
        ...
        Slide(data=TableData(
            ...
            subtitle="科技概念 × 核心场景 · 小红书 2025.01–10",
...
if __name__ == "__main__":
    dest = ROOT / "out" / "isdin_morandi"
    out = sys.argv[1] if len(sys.argv) > 1 else str(dest / "isdin_morandi.pptx")
