"""Image-mode for the riso look. Two entry points:

  riso_ify(src, theme)   -> take ANY photo/illustration and screen-print it:
  ...
  make_hero(art, theme)  -> generate riso poster art from scratch (no source):
...
def riso_ify(src_path: str, theme, out_path: str, dot: int = 7):
